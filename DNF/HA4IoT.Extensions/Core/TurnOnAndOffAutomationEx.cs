...
{
    public class TurnOnAndOffAutomationEx : AutomationBase
    {
        ...
        public TurnOnAndOffAutomationEx(string id, IDateTimeService dateTimeService, ISchedulerService schedulerService, ISettingsService settingsService, IDaylightService daylightService)
            : base(id)
        {
        ...
        public TurnOnAndOffAutomationEx WithTrigger(IMotionDetector motionDetector)
        {
        ...
        public TurnOnAndOffAutomationEx WithTrigger(ITrigger trigger)
        {
        ...
        public TurnOnAndOffAutomationEx WithTarget(IComponent component)
        {
        ...
        public TurnOnAndOffAutomationEx WithTurnOnWithinTimeRange(Func<TimeSpan> from, Func<TimeSpan> until)
        {
        ...
        public TurnOnAndOffAutomationEx WithEnablingCondition(ConditionRelation relation, ICondition condition)
        {
        ...
        public TurnOnAndOffAutomationEx WithEnabledAtDay()
        {
        ...
        public TurnOnAndOffAutomationEx WithEnabledAtNight()
        {
        ...
        public TurnOnAndOffAutomationEx WithSkipIfAnyIsAlreadyOn(params IComponent[] components)
        {
        ...
        public TurnOnAndOffAutomationEx WithTurnOffIfButtonPressedWhileAlreadyOn()
        {
            _turnOffIfButtonPressedWhileAlreadyOn = true;
            return this;
        }

        public TurnOnAndOffAutomationEx WithPauseAfterEveryTurnOn(TimeSpan duration)
        {
        ...
        public TurnOnAndOffAutomationEx WithTurnOffCondition(ConditionRelation relation, ICondition condition)
        {
            if (condition == null) throw new ArgumentNullException(nameof(condition));
        ...
        public TurnOnAndOffAutomationEx WithDisableTurnOffWhenBinaryStateEnabled(IBinaryInput input)
        {
