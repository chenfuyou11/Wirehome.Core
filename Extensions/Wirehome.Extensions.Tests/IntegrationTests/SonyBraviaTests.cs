...
namespace Wirehome.Extensions.Tests.IntegrationTests
{
    ...
    {
        public const string SONY_HOST = "192.168.0.107";
        ...
        public async Task SonyPowerTest()
        {
            ...
            var sony = new SonyBraviaTV(Guid.NewGuid().ToString(), ev)
            {
                Hostname = SONY_HOST,
        ...
        public async Task SonyVolumeTest()
        {
            ...
            await sony.ExecuteAsyncCommand<VolumeUpCommand>().ConfigureAwait(false);
        }
        //
    }
}
